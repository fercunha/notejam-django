...
# Fetch all hosts in us-west-1, the hostname is the public DNS if it exists, otherwise the private IP address
plugin: aws_ec2
regions:
  - us-west-1
...
class InventoryModule(BaseInventoryPlugin, Constructable, Cacheable):
    ...
    def _get_connection(self, credentials, region='us-west-1'):
        try:
