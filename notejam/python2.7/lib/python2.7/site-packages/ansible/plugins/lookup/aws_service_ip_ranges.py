...
options:
  ...
  region:
    description: 'The AWS region to narrow the ranges to. Examples: us-west-1, eu-west-2, ap-southeast-1'
"""
...
- name: "Pull S3 IP ranges, and print the default return style"
  debug: msg="{{ lookup('aws_service_ip_ranges', region='us-west-1', service='S3') }}"
