        ...
        lambda_function_associations:
          ...
          contains:
            ...
            items:
              ...
              type: list
              sample:
              - lambda_function_arn: arn:aws:lambda:123456789012:us-west-1/lambda/lambda-function
...
viewer_certificate:
  ...
  contains:
    acm_certificate_arn:
      ...
      type: string
      sample: arn:aws:acm:us-west-1:123456789012:certificate/abcd1234-1234-1234-abcd-123456abcdef
    certificate:
