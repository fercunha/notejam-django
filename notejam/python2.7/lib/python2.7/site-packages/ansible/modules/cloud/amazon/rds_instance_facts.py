...
instances:
  ...
  contains:
    ...
    db_instance_arn:
      ...
      returned: always
      type: string
      sample: arn:aws:rds:us-west-1:111111111111:db:helloworld-rds
    db_instance_class:
    ...
    endpoint:
      ...
      contains:
        address:
          ...
          returned: always
          type: string
          sample: helloworld-rds.ctrqpe3so1sf.us-west-1.rds.amazonaws.com
        hosted_zone_id:
    ...
    kms_key_id:
      ...
      returned: always
      type: string
      sample: arn:aws:kms:us-west-1:111111111111:key/abcd1234-0000-abcd-1111-0123456789ab
