...
db_instance_arn:
  ...
  returned: always
  type: string
  sample: arn:aws:rds:us-west-1:123456789012:db:ansible-test
db_instance_class:
...
endpoint:
  ...
  contains:
    address:
      ...
      returned: always
      type: string
      sample: ansible-test.cvlrtwiennww.us-west-1.rds.amazonaws.com
    hosted_zone_id:
...
kms_key_id:
  ...
  type: string
  sample: arn:aws:kms:us-west-1:123456789012:key/70c45553-ad2e-4a85-9f14-cfeb47555c33
