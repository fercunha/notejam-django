...
auto_scaling_group_arn:
    ...
    returned: success
    type: string
    sample: "arn:aws:autoscaling:us-west-1:1234567890:autoScalingGroup:10787c52-0bcb-427d-82ba-c8e4b008ed2e:autoScalingGroupName/public-webapp-production-1"
...
availability_zones:
    ...
    returned: success
    type: list
    sample: ["us-west-1a", "us-west-1b", "us-west-1a"]
created_time:
...
def find_asgs(conn, module, name=None, tags=None):
    ...
    Basic Usage:
        ...
        >>> tags = { 'env': 'production' }
        >>> conn = boto3.client('autoscaling', region_name='us-west-1')
    ...
    Returns:
        ...
        [
            {
                "auto_scaling_group_arn": (
                    "arn:aws:autoscaling:us-west-1:275977225706:autoScalingGroup:58abc686-9783-4528-b338-3ad6f1cbbbaf:"
                    "autoScalingGroupName/public-webapp-production"
                ),
                "auto_scaling_group_name": "public-webapp-production",
                "availability_zones": ["us-west-1c", "us-west-1b", "us-west-1a"],
