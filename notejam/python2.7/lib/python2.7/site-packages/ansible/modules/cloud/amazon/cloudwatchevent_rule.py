...
- cloudwatchevent_rule:
    ...
    targets:
      - id: MyTargetId
        arn: arn:aws:lambda:us-west-1:123456789012:function:MyFunction
...
rule:
    ...
    type: dict
    sample:
      arn: 'arn:aws:events:us-west-1:123456789012:rule/MyCronTask'
      description: 'Run my scheduled task'
      name: 'MyCronTask'
      schedule_expression: 'cron(0 20 * * ? *)'
      state: 'ENABLED'
targets:
    ...
    returned: success
    type: list
    sample: "[{ 'arn': 'arn:aws:lambda:us-west-1:123456789012:function:MyFunction', 'id': 'MyTargetId' }]"
'''
