...
snapshots:
  ...
  contains:
    ...
    db_snapshot_arn:
      ...
      returned: always
      type: string
      sample: arn:aws:rds:us-west-1:111111111111:snapshot:rds:hello-world-rds-us1-2018-05-16-04-03
    db_snapshot_identifier:
    ...
    kms_key_id:
      ...
      returned: always
      type: string
      sample: arn:aws:kms:us-west-1:111111111111:key/abcd1234-1234-aaaa-0000-1234567890ab
    license_model:
